...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    create_remote_user = CreateRemoteUser(
        first_name="Shensi",
        last_name="Ding",
    ...
    # and optional values
    try:
        api_response = api_instance.users_create(x_account_token, run_async=run_async, create_remote_user=create_remote_user)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling UsersApi->users_create: %s\n" % e)
```
 ...
 **create_remote_user** | [**CreateRemoteUser**](CreateRemoteUser.md)|  | [optional]
