...
# **departments_create**
> Department departments_create(x_account_token)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    create_department = CreateDepartment(
        name="Engineering",
    ) # CreateDepartment |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.departments_create(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.departments_create(x_account_token, run_async=run_async, create_department=create_department)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling DepartmentsApi->departments_create: %s\n" % e)
```
 ...
 **create_department** | [**CreateDepartment**](CreateDepartment.md)|  | [optional]
