...
[**departments_update**](DepartmentsApi.md#departments_update) | **PUT** /departments/{id} | 


# **departments_create**
> Department departments_create(x_account_token=x_account_token, run_async=run_async, department=department)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    api_instance = MergeATSClient.DepartmentsApi(api_client)
    x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
department = MergeATSClient.Department() # Department |  (optional)

    try:
        api_response = api_instance.departments_create(x_account_token=x_account_token, run_async=run_async, department=department)
        pprint(api_response)
...
# **departments_destroy**
> Office departments_destroy(id, x_account_token=x_account_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.departments_destroy(id, x_account_token=x_account_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **departments_list**
> PaginatedDepartmentList departments_list(created_after=created_after, created_before=created_before, cursor=cursor, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.departments_list(created_after=created_after, created_before=created_before, cursor=cursor, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
> Department departments_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_department=patched_department)
...
x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
patched_department = MergeATSClient.PatchedDepartment() # PatchedDepartment |  (optional)

    try:
        api_response = api_instance.departments_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_department=patched_department)
        pprint(api_response)
    except ApiException as e:
...
> Department departments_retrieve(id, x_account_token=x_account_token)
...
x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
    ...
    try:
        api_response = api_instance.departments_retrieve(id, x_account_token=x_account_token)
        pprint(api_response)
    except ApiException as e:
...
# **departments_update**
> Department departments_update(id, department=department)
...
department = MergeATSClient.Department() # Department |  (optional)
    ...
    try:
        api_response = api_instance.departments_update(id, department=department)
        pprint(api_response)
    except ApiException as e:
