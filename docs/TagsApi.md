...
# **tags_create**
> Tag tags_create(x_account_token)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.tags_create(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.tags_create(x_account_token, run_async=run_async, create_tag=create_tag)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling TagsApi->tags_create: %s\n" % e)
```
 ...
 **create_tag** | [**CreateTag**](CreateTag.md)|  | [optional]
