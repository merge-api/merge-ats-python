...
[**tags_update**](TagsApi.md#tags_update) | **PUT** /tags/{id} | 


# **tags_create**
> Tag tags_create(x_account_token=x_account_token, run_async=run_async, tag=tag)
...
tag = MergeATSClient.Tag() # Tag |  (optional)

    try:
        api_response = api_instance.tags_create(x_account_token=x_account_token, run_async=run_async, tag=tag)
        pprint(api_response)
...
# **tags_destroy**
> Tag tags_destroy(id, x_account_token=x_account_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.tags_destroy(id, x_account_token=x_account_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **tags_list**
> PaginatedTagList tags_list(x_account_token=x_account_token, candidate_id=candidate_id, created_after=created_after, created_before=created_before, cursor=cursor, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    api_instance = MergeATSClient.TagsApi(api_client)
    x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
candidate_id = 'candidate_id_example' # str | If provided, will only return tags for this candidate. (optional)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.tags_list(x_account_token=x_account_token, candidate_id=candidate_id, created_after=created_after, created_before=created_before, cursor=cursor, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **x_account_token** | **str**| Token identifying the end user. | [optional] 
 **candidate_id** | [**str**](.md)| If provided, will only return tags for this candidate. | [optional] 
...
# **tags_partial_update**
> Tag tags_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_tag=patched_tag)
...
x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
patched_tag = MergeATSClient.PatchedTag() # PatchedTag |  (optional)

    try:
        api_response = api_instance.tags_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_tag=patched_tag)
        pprint(api_response)
    except ApiException as e:
...
tag = MergeATSClient.Tag() # Tag |  (optional)
    ...
    try:
        api_response = api_instance.tags_update(id, tag=tag)
        pprint(api_response)
    except ApiException as e:
