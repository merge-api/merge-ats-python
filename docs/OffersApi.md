...
# **offers_create**
> Offer offers_create(x_account_token)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.offers_create(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.offers_create(x_account_token, run_async=run_async, create_offer=create_offer)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling OffersApi->offers_create: %s\n" % e)
```
 ...
 **create_offer** | [**CreateOffer**](CreateOffer.md)|  | [optional]
