...
> RejectReason reject_reasons_create(x_account_token)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    create_reject_reason = CreateRejectReason(
        name="Not passionate enough about APIs.",
    ) # CreateRejectReason |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.reject_reasons_create(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.reject_reasons_create(x_account_token, run_async=run_async, create_reject_reason=create_reject_reason)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling RejectReasonsApi->reject_reasons_create: %s\n" % e)
```
 ...
 **create_reject_reason** | [**CreateRejectReason**](CreateRejectReason.md)|  | [optional]
