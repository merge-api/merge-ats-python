...
[**eeocs_update**](EeocsApi.md#eeocs_update) | **PUT** /eeocs/{id} | 


# **eeocs_create**
> EEOC eeocs_create(x_account_token=x_account_token, run_async=run_async, eeoc=eeoc)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    api_instance = MergeATSClient.EeocsApi(api_client)
    x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
eeoc = MergeATSClient.EEOC() # EEOC |  (optional)

    try:
        api_response = api_instance.eeocs_create(x_account_token=x_account_token, run_async=run_async, eeoc=eeoc)
        pprint(api_response)
...
# **eeocs_destroy**
> EEOC eeocs_destroy(id, x_account_token=x_account_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.eeocs_destroy(id, x_account_token=x_account_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EeocsApi->eeocs_destroy: %s\n" % e)
```
...
# **eeocs_list**
> PaginatedEEOCList eeocs_list(x_account_token=x_account_token, candidate_id=candidate_id, created_after=created_after, created_before=created_before, cursor=cursor, expand=expand, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.eeocs_list(x_account_token=x_account_token, candidate_id=candidate_id, created_after=created_after, created_before=created_before, cursor=cursor, expand=expand, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
------------- | ------------- | ------------- | -------------
 **x_account_token** | **str**| Token identifying the end user. | [optional] 
 **candidate_id** | [**str**](.md)| If provided, will only return EEOC info for this candidate. | [optional] 
...
> EEOC eeocs_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_eeoc=patched_eeoc)
...
x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
patched_eeoc = MergeATSClient.PatchedEEOC() # PatchedEEOC |  (optional)

    try:
        api_response = api_instance.eeocs_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_eeoc=patched_eeoc)
        pprint(api_response)
    except ApiException as e:
...
# **eeocs_retrieve**
> EEOC eeocs_retrieve(id, x_account_token=x_account_token, expand=expand)
...
expand = 'expand_example' # str | Which relations should be returned in expanded form. (optional)
    ...
    try:
        api_response = api_instance.eeocs_retrieve(id, x_account_token=x_account_token, expand=expand)
        pprint(api_response)
    except ApiException as e:
...
# **eeocs_update**
> EEOC eeocs_update(id, eeoc=eeoc)
...
eeoc = MergeATSClient.EEOC() # EEOC |  (optional)
    ...
    try:
        api_response = api_instance.eeocs_update(id, eeoc=eeoc)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EeocsApi->eeocs_update: %s\n" % e)
```
