...
# **activities_create**
> Activity activities_create(x_account_token, remote_user_id)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    activity_request = ActivityRequest(
        ...
        visibility=,
    ) # ActivityRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.activities_create(x_account_token, remote_user_id)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.activities_create(x_account_token, remote_user_id, run_async=run_async, activity_request=activity_request)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling ActivitiesApi->activities_create: %s\n" % e)
```
 ...
 **activity_request** | [**ActivityRequest**](ActivityRequest.md)|  | [optional]
