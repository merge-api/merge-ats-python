...
[**scorecards_update**](ScorecardsApi.md#scorecards_update) | **PUT** /scorecards/{id} | 
...
# **scorecards_update**
> Scorecard scorecards_update(id, scorecard=scorecard)
...
scorecard = MergeATSClient.Scorecard() # Scorecard |  (optional)
    ...
    try:
        api_response = api_instance.scorecards_update(id, scorecard=scorecard)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ScorecardsApi->scorecards_update: %s\n" % e)
```
