...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    create_scorecard = CreateScorecard(
    ...
    # and optional values
    try:
        api_response = api_instance.scorecards_create(x_account_token, run_async=run_async, create_scorecard=create_scorecard)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling ScorecardsApi->scorecards_create: %s\n" % e)
```
 ...
 **create_scorecard** | [**CreateScorecard**](CreateScorecard.md)|  | [optional]
