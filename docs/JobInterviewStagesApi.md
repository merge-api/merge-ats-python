...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    create_job_interview_stage = CreateJobInterviewStage(
        name="Phone Screen",
        job="ba7d9648-5316-4a80-8d73-4e636cef5a90",
    ) # CreateJobInterviewStage |  (optional)
    ...
    # and optional values
    try:
        api_response = api_instance.job_interview_stages_create(x_account_token, run_async=run_async, create_job_interview_stage=create_job_interview_stage)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling JobInterviewStagesApi->job_interview_stages_create: %s\n" % e)
```
 ...
 **create_job_interview_stage** | [**CreateJobInterviewStage**](CreateJobInterviewStage.md)|  | [optional]
