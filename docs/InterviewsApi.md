...
# **interviews_create**
> ScheduledInterview interviews_create(x_account_token)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    create_scheduled_interview = CreateScheduledInterview(
    ...
    ) # CreateScheduledInterview |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.interviews_create(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.interviews_create(x_account_token, run_async=run_async, create_scheduled_interview=create_scheduled_interview)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling InterviewsApi->interviews_create: %s\n" % e)
```
 ...
 **create_scheduled_interview** | [**CreateScheduledInterview**](CreateScheduledInterview.md)|  | [optional]
