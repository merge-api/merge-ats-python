...
[**interviews_update**](InterviewsApi.md#interviews_update) | **PUT** /interviews/{id} | 
...
# **interviews_update**
> ScheduledInterview interviews_update(id, scheduled_interview=scheduled_interview)
...
scheduled_interview = MergeATSClient.ScheduledInterview() # ScheduledInterview |  (optional)
    ...
    try:
        api_response = api_instance.interviews_update(id, scheduled_interview=scheduled_interview)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling InterviewsApi->interviews_update: %s\n" % e)
```
