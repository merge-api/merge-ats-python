...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.attachments_create(x_account_token, run_async=run_async, create_attachment=create_attachment)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling AttachmentsApi->attachments_create: %s\n" % e)
```
 ...
 **create_attachment** | [**CreateAttachment**](CreateAttachment.md)|  | [optional]
