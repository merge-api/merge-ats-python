...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.applications_create(x_account_token, run_async=run_async, create_application=create_application)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling ApplicationsApi->applications_create: %s\n" % e)
```
 ...
 **create_application** | [**CreateApplication**](CreateApplication.md)|  | [optional]
