...
[**applications_update**](ApplicationsApi.md#applications_update) | **PUT** /applications/{id} | 
...
# **applications_update**
> Application applications_update(id, application=application)
...
application = MergeATSClient.Application() # Application |  (optional)
    ...
    try:
        api_response = api_instance.applications_update(id, application=application)
        pprint(api_response)
    except ApiException as e:
