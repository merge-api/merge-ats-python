...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.candidates_create(x_account_token, run_async=run_async, create_candidate=create_candidate)
        pprint(api_response)
    except MergeATSClient.ApiException as e:
        print("Exception when calling CandidatesApi->candidates_create: %s\n" % e)
```
 ...
 **create_candidate** | [**CreateCandidate**](CreateCandidate.md)|  | [optional]
