...
[**candidates_update**](CandidatesApi.md#candidates_update) | **PUT** /candidates/{id} | 


# **candidates_create**
> Candidate candidates_create(x_account_token=x_account_token, run_async=run_async, candidate=candidate)
...
with MergeATSClient.ApiClient(configuration) as api_client:
    ...
    api_instance = MergeATSClient.CandidatesApi(api_client)
    x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
candidate = MergeATSClient.Candidate() # Candidate |  (optional)

    try:
        api_response = api_instance.candidates_create(x_account_token=x_account_token, run_async=run_async, candidate=candidate)
        pprint(api_response)
...
# **candidates_destroy**
> Candidate candidates_destroy(id, x_account_token=x_account_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.candidates_destroy(id, x_account_token=x_account_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CandidatesApi->candidates_destroy: %s\n" % e)
```
...
# **candidates_list**
> PaginatedCandidateList candidates_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, expand=expand, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.candidates_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, expand=expand, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
> Candidate candidates_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_candidate=patched_candidate)
...
x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
patched_candidate = MergeATSClient.PatchedCandidate() # PatchedCandidate |  (optional)

    try:
        api_response = api_instance.candidates_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_candidate=patched_candidate)
        pprint(api_response)
    except ApiException as e:
...
# **candidates_retrieve**
> Candidate candidates_retrieve(id, x_account_token=x_account_token, expand=expand)
...
expand = 'expand_example' # str | Which relations should be returned in expanded form. (optional)
    ...
    try:
        api_response = api_instance.candidates_retrieve(id, x_account_token=x_account_token, expand=expand)
        pprint(api_response)
    except ApiException as e:
...
# **candidates_update**
> Candidate candidates_update(id, candidate=candidate)
...
candidate = MergeATSClient.Candidate() # Candidate |  (optional)
    ...
    try:
        api_response = api_instance.candidates_update(id, candidate=candidate)
        pprint(api_response)
    except ApiException as e:
