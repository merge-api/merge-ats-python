...
from MergeATSClient.models.paginated_application_list import PaginatedApplicationList  # noqa: E501
...
class TestPaginatedApplicationList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = MergeATSClient.models.paginated_application_list.PaginatedApplicationList()  # noqa: E501
        if include_optional :
            return PaginatedApplicationList(
                next = '0', 
                previous = '0', 
                results = [
                    MergeATSClient.models.application.Application(
