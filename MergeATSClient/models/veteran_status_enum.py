...
class VeteranStatusEnum(object):
    ...
    allowable_values = [AM_NOT_A_PROTECTED_VETERAN, IDENTIFY_AS_ONE_OR_MORE_OF_THE_CLASSIFICATIONS_OF_A_PROTECTED_VETERAN, DONT_WISH_TO_ANSWER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """VeteranStatusEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VeteranStatusEnum):
            return False
