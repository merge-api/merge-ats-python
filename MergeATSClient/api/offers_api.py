...
class OffersApi(object):
    ...
    def offers_create(self, **kwargs):  # noqa: E501
        """offers_create  # noqa: E501

        Creates an `Offer` object with the given values.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_create(async_req=True)
        >>> result = thread.get()
        ...
        return self.offers_create_with_http_info(**kwargs)  # noqa: E501

    def offers_create_with_http_info(self, **kwargs):  # noqa: E501
        """offers_create  # noqa: E501

        Creates an `Offer` object with the given values.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_create_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def offers_destroy(self, id, **kwargs):  # noqa: E501
        """offers_destroy  # noqa: E501

        Deletes an `Offer` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_destroy(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offers_destroy_with_http_info(id, **kwargs)  # noqa: E501

    def offers_destroy_with_http_info(self, id, **kwargs):  # noqa: E501
        """offers_destroy  # noqa: E501

        Deletes an `Offer` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_destroy_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `offers_destroy`")  # noqa: E501
    ...
    def offers_list(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str x_account_token: Token identifying the end user.
        :param str application_id: If provided, will only return offers for this application.
        ...
        :param str creator_id: If provided, will only return offers created by this user.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offers_list_with_http_info(**kwargs)  # noqa: E501

    def offers_list_with_http_info(self, **kwargs):  # noqa: E501
        """offers_list  # noqa: E501

        Returns a list of `Offer` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedOfferList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedOfferList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def offers_partial_update(self, id, **kwargs):  # noqa: E501
        """offers_partial_update  # noqa: E501

        Updates an `Offer` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_partial_update(id, async_req=True)
        >>> result = thread.get()
        ...
        :param str x_account_token: Token identifying the end user.
        :param bool run_async: Whether or not third-party updates should be run asynchronously.
        :param PatchedOffer patched_offer:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offers_partial_update_with_http_info(id, **kwargs)  # noqa: E501

    def offers_partial_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """offers_partial_update  # noqa: E501

        Updates an `Offer` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_partial_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method offers_partial_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `offers_partial_update`")  # noqa: E501
        ...
        body_params = None
        if 'patched_offer' in local_var_params:
            body_params = local_var_params['patched_offer']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def offers_retrieve(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offers_retrieve_with_http_info(id, **kwargs)  # noqa: E501

    def offers_retrieve_with_http_info(self, id, **kwargs):  # noqa: E501
        """offers_retrieve  # noqa: E501

        Returns an `Offer` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_retrieve_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `offers_retrieve`")  # noqa: E501
    ...
    def offers_update(self, id, **kwargs):  # noqa: E501
        """offers_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_update(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offers_update_with_http_info(id, **kwargs)  # noqa: E501

    def offers_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """offers_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `offers_update`")  # noqa: E501
