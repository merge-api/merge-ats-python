...
class OffersApi(object):
    ...
    def offers_list(self, x_account_token, **kwargs):  # noqa: E501
        ...
        return self.offers_list_with_http_info(x_account_token, **kwargs)  # noqa: E501

    def offers_list_with_http_info(self, x_account_token, **kwargs):  # noqa: E501
        """offers_list  # noqa: E501

        Returns a list of `Offer` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_list_with_http_info(x_account_token, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `offers_list`")  # noqa: E501
    ...
    def offers_retrieve(self, x_account_token, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offers_retrieve_with_http_info(x_account_token, id, **kwargs)  # noqa: E501

    def offers_retrieve_with_http_info(self, x_account_token, id, **kwargs):  # noqa: E501
        """offers_retrieve  # noqa: E501

        Returns an `Offer` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offers_retrieve_with_http_info(x_account_token, id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_account_token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `offers_retrieve`")  # noqa: E501
