...
class ActivitiesApi(object):
    ...
    def activities_create(self, **kwargs):  # noqa: E501
        ...
        return self.activities_create_with_http_info(**kwargs)  # noqa: E501

    def activities_create_with_http_info(self, **kwargs):  # noqa: E501
        """activities_create  # noqa: E501

        Creates an `Activity` object with the given values.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method activities_create" % key
                )
    ...
    def activities_destroy(self, id, **kwargs):  # noqa: E501
        """activities_destroy  # noqa: E501

        Deletes an `Activity` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_destroy(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.activities_destroy_with_http_info(id, **kwargs)  # noqa: E501

    def activities_destroy_with_http_info(self, id, **kwargs):  # noqa: E501
        """activities_destroy  # noqa: E501

        Deletes an `Activity` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_destroy_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activities_destroy" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `activities_destroy`")  # noqa: E501
    ...
    def activities_list(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.activities_list_with_http_info(**kwargs)  # noqa: E501

    def activities_list_with_http_info(self, **kwargs):  # noqa: E501
        """activities_list  # noqa: E501

        Returns a list of `Activity` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_list_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def activities_partial_update(self, id, **kwargs):  # noqa: E501
        """activities_partial_update  # noqa: E501

        Updates an `Activity` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_partial_update(id, async_req=True)
        >>> result = thread.get()
        ...
        :param str x_account_token: Token identifying the end user.
        :param bool run_async: Whether or not third-party updates should be run asynchronously.
        :param PatchedActivity patched_activity:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.activities_partial_update_with_http_info(id, **kwargs)  # noqa: E501

    def activities_partial_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """activities_partial_update  # noqa: E501

        Updates an `Activity` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_partial_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activities_partial_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `activities_partial_update`")  # noqa: E501
        ...
        body_params = None
        if 'patched_activity' in local_var_params:
            body_params = local_var_params['patched_activity']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def activities_retrieve(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.activities_retrieve_with_http_info(id, **kwargs)  # noqa: E501

    def activities_retrieve_with_http_info(self, id, **kwargs):  # noqa: E501
        """activities_retrieve  # noqa: E501

        Returns an `Activity` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_retrieve_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def activities_update(self, id, **kwargs):  # noqa: E501
        """activities_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_update(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.activities_update_with_http_info(id, **kwargs)  # noqa: E501

    def activities_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """activities_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activities_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method activities_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `activities_update`")  # noqa: E501
