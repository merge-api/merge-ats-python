...
class OfficesApi(object):
    ...
    def offices_list(self, x_account_token, **kwargs):  # noqa: E501
        ...
        return self.offices_list_with_http_info(x_account_token, **kwargs)  # noqa: E501

    def offices_list_with_http_info(self, x_account_token, **kwargs):  # noqa: E501
        """offices_list  # noqa: E501

        Returns a list of `Office` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offices_list_with_http_info(x_account_token, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `offices_list`")  # noqa: E501
    ...
    def offices_retrieve(self, x_account_token, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.offices_retrieve_with_http_info(x_account_token, id, **kwargs)  # noqa: E501

    def offices_retrieve_with_http_info(self, x_account_token, id, **kwargs):  # noqa: E501
        """offices_retrieve  # noqa: E501

        Returns an `Office` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.offices_retrieve_with_http_info(x_account_token, id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_account_token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `offices_retrieve`")  # noqa: E501
