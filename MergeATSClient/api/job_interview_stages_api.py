...
class JobInterviewStagesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __job_interview_stages_create(
            self,
            x_account_token,
            **kwargs
        ):
            ...
            >>> thread = api.job_interview_stages_create(x_account_token, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                ...
                create_job_interview_stage (CreateJobInterviewStage): [optional]
        ...
        self.job_interview_stages_create = Endpoint(
            settings={
                ...
                'operation_id': 'job_interview_stages_create',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'run_async': 'query',
                    'create_job_interview_stage': 'body',
                },
            ...
            callable=__job_interview_stages_create
        )
