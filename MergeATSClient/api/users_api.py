...
class UsersApi(object):
    ...
    def users_list(self, x_account_token, **kwargs):  # noqa: E501
        ...
        return self.users_list_with_http_info(x_account_token, **kwargs)  # noqa: E501

    def users_list_with_http_info(self, x_account_token, **kwargs):  # noqa: E501
        """users_list  # noqa: E501

        Returns a list of `RemoteUser` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_list_with_http_info(x_account_token, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedRemoteUserList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `users_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedRemoteUserList',  # noqa: E501
    ...
    def users_retrieve(self, x_account_token, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.users_retrieve_with_http_info(x_account_token, id, **kwargs)  # noqa: E501

    def users_retrieve_with_http_info(self, x_account_token, id, **kwargs):  # noqa: E501
        """users_retrieve  # noqa: E501

        Returns a `RemoteUser` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_retrieve_with_http_info(x_account_token, id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RemoteUser, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_account_token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `users_retrieve`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RemoteUser',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
