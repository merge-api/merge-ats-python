...
class UsersApi(object):
    ...
    def users_create_with_http_info(self, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'remote_user' in local_var_params:
            body_params = local_var_params['remote_user']
        # HTTP header `Accept`
    ...
    def users_destroy(self, id, **kwargs):  # noqa: E501
        ...
        Deletes a `RemoteUser` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def users_destroy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `users_destroy`")  # noqa: E501
    ...
    def users_partial_update(self, id, **kwargs):  # noqa: E501
        ...
        :param str x_account_token: Token identifying the end user.
        :param bool run_async: Whether or not third-party updates should be run asynchronously.
        :param PatchedRemoteUser patched_remote_user:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def users_partial_update_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'patched_remote_user' in local_var_params:
            body_params = local_var_params['patched_remote_user']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
